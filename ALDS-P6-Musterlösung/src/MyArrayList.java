/**
 * Implementierung der Schnittstelle SimpleList mit Hilfe
 * eines Feldes, das bei Bedarf vergrößert wird
 *
 * Die gespeicherten Objektreferenzen dürfen im Gegensatz
 * zur Klasse ArrayList in der Java-Klassenbibliothek nicht
 * gleich null sein.
 */
...
implements SimpleList
{
	...
	public MyArrayList()
	{
		this.elementData = new Object[10];	// Erzeugung eines Feldes mit der Startgröße 10
		this.size = 0;
	}
	
	// Operationen
	/**
	 * Sicherstellen, dass das Feld groß genug ist, um 
	 * minCapacity Objekte speichern zu können.
	 * Ist dies nicht der Fall, wird ein neues Feld erzeugt,
	 * und die gespeicherten Objekte in das neue Feld umkopiert.
	 */
	 ...
	 * Elemente ab der Position index+1 um 1 nach links schieben
	   Element an der Position index wird überschrieben.
	 */
	 ...
	 * und Rückgabe des an dieser Position gepseicherten Objekts
	 */	
